...
mixin _$LoginState {
 ...
 UserEmailValidator get email; UserPasswordValidator get password; FormzSubmissionStatus get status;
...
@useResult
$Res call({
 UserEmailValidator email, UserPasswordValidator password, FormzSubmissionStatus status
});
...
as UserPasswordValidator,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UserEmailValidator email,  UserPasswordValidator password,  FormzSubmissionStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UserEmailValidator email,  UserPasswordValidator password,  FormzSubmissionStatus status)  $default,) {final _that = this;
switch (_that) {
case _LoginState():
return $default(_that.email,_that.password,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UserEmailValidator email,  UserPasswordValidator password,  FormzSubmissionStatus status)?  $default,) {final _that = this;
switch (_that) {
case _LoginState() when $default != null:
return $default(_that.email,_that.password,_that.status);case _:
  return null;
...
class _LoginState extends LoginState {
  const _LoginState({this.email = const UserEmailValidator.pure(), this.password = const UserPasswordValidator.pure(), this.status = FormzSubmissionStatus.initial}): super._();
